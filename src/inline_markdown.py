...
def text_to_textnodes(text):
    ...
    text_nodes_italic_split = split_nodes_delimiter(text_nodes_bold_split, '_', TextType.ITALIC)
    text_nodes_code_split = split_nodes_delimiter(text_nodes_italic_split, '`', TextType.CODE)
